# Microsoft Elements TypeSpec REST API Specification

## Description

This folder contains the *[TypeSpec](https://azure.github.io/typespec-azure/)
REST API Specification* for the **[Microsoft Elements](https://quantum.microsoft.com)** service.

Please see the [repository README](../../../README.md) for details on how to use
this *TypeSpec* specification for generating *REST API clients* for the **Microsoft Elements** service
