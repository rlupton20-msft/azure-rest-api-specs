...
6. Compile your `*.tsp` and re-generate examples:
   - *Control plane:* `node specification/discoverydev/scripts/makeExamples--ControlPlane.mjs`
   - *Bookshelf data plane:* `node specification/discoverydev/scripts/makeExamples--Bookshelf.mjs`
   - *Catalog data plane:* `node specification/discoverydev/scripts/makeExamples--Catalog.mjs`
   - *Workspace data plane:* `node specification/discoverydev/scripts/makeExamples--Workspace.mjs`
