...
const runMain = () => {
  ...
  const makeDirs  = () => {
    for( const apiVersion of apiVersions ) {
      dirs.push({
        inDir:
          `specification/discoverydev/resource-manager/Private.Discovery/preview/${apiVersion}/examples`,
        outDir:
          `specification/discoverydev/Discovery.Management/examples/${apiVersion}`,
      });
