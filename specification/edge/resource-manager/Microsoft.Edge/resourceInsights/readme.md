...
tag: resourceInsights-package-2024-06-01-preview
```

### Tag: resourceInsights-package-2024-06-01-preview

These settings apply only when `--tag=resourceInsights-package-2024-06-01-preview` is specified on the command line.

```yaml $(tag) == 'resourceInsights-package-2024-06-01-preview'
input-file:
