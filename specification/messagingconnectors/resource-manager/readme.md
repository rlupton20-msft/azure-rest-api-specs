...
input-file:
  - Private.MessagingConnectors/preview/2025-10-01-preview/messagingconnectors.json
```
...
input-file:
  - Private.MessagingConnectors/preview/2025-09-01-preview/messagingconnectors.json
```
...
input-file:
  - Private.MessagingConnectors/preview/2025-08-01-preview/messagingconnectors.json
```
...
input-file:
  - Private.MessagingConnectors/preview/2025-07-01-preview/messagingconnectors.json
```
...
input-file:
  - Private.MessagingConnectors/preview/2025-06-01-preview/messagingconnectors.json
```
...
input-file:
  - Private.MessagingConnectors/preview/2025-05-01-preview/messagingconnectors.json
```
...
input-file:
  - Private.MessagingConnectors/preview/2025-03-01-preview/messagingconnectors.json
```
...
input-file:
  - Private.MessagingConnectors/preview/2025-02-01-preview/messagingconnectors.json
```
...
input-file:
  - Private.MessagingConnectors/preview/2025-01-01-preview/messagingconnectors.json
```
