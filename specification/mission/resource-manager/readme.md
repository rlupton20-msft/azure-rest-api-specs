...
tag: package-private-2025-11-01-preview
```

### Tag: package-private-2025-11-01-preview

These settings apply only when `--tag=package-private-2025-11-01-preview` is specified on the command line.

```yaml $(tag) == 'package-private-2025-11-01-preview'
input-file:
  - Private.Mission/preview/2025-11-01-preview/openapi.json
```

### Tag: package-private-2025-10-01-preview

These settings apply only when `--tag=package-private-2025-10-01-preview` is specified on the command line.

```yaml $(tag) == 'package-private-2025-10-01-preview'
input-file:
  - Private.Mission/preview/2025-10-01-preview/openapi.json
```
