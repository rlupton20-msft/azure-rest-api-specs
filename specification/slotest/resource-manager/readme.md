...
This is the AutoRest configuration file for SloTest.
...
These are the global settings for the SloTest.
...
input-file:
  - Microsoft.SloTest/preview/2024-08-01-preview/openapi.json
```