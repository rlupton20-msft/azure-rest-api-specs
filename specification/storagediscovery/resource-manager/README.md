...
```yaml $(tag) == 'package-2025-01-01-preview'
input-file:
  - Private.StorageDiscovery/preview/2025-01-01-preview/storageDiscoveryWorkspace.json
```
...
```yaml $(tag) == 'package-2025-03-01-preview'
input-file:
  - Private.StorageDiscovery/preview/2025-03-01-preview/storageDiscoveryWorkspace.json
```
...
```yaml $(tag) == 'package-2025-04-01-preview'
input-file:
  - Private.StorageDiscovery/preview/2025-04-01-preview/storageDiscoveryWorkspace.json
```
...
```yaml $(tag) == 'package-2025-06-01-preview'
input-file:
  - Private.StorageDiscovery/preview/2025-06-01-preview/storageDiscoveryWorkspace.json
```
